        ...
        <Row className="show-grid pt-3">
          ...
          <Col xs={12} sm={12} lg={6} xl={6}>
            <div className="flex-col">
              ...
              <div className="prop-header-data">
                <div className="type-wrap">{data.types.length && data.types.map((item: any, index: number) => <ColorfulTag className="pr-1" key={item.type.name + index} type={item.type.name} text={getCamleCaseString(item.type.name)} />)}</div>
              </div>
            </div>
          </Col>
          <Col xs={12} sm={12} lg={12} xl={12}>
            <div className="flex-col">
              ...
              <div className="prop-header-data type-wrap">{pokemonTypeData.damage_relations.double_damage_from.length && pokemonTypeData.damage_relations.double_damage_from.map((item: any, index: number) => <ColorfulTag key={item.name + index} className="pr-1" type={item.name} text={getCamleCaseString(item.name)} />)}</div>
            </div>
          </Col>
        </Row>
      </Grid>
